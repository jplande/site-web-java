...
if(isset($_POST['create'])){
 ...
 $create = Client::createClient($_POST['email'],$_POST['pass'],$_POST['tel']);
 if($create == true){
     ?>
     <script>
...
<section id="hero">
    <div class="hero-container">
        ...
        <div class="row" style="width: 80%;margin-left: 10% !important;">
            <form class="user" style="width: 100%;" action="register.php" method="post">
                ...
                <br>
                <div class="col-lg-12 col-md-12 wow fadeInUp">
                    <input type="phone" name="tel" class="form-control form-control-user"
                           id="exampleInputPassword" placeholder="Telephone">
                </div>
                <br>
                <div class="col-lg-12 col-md-12 img-fluid animated fadeInUp">
                    <button type="submit" name="create" value="true" class="btn btn-primary btn-user btn-block">Crée le compte</button>
                </div>
            </form>
