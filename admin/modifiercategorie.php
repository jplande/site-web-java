...
$cat = Categories::getCategoriesWithId($_GET['idcat']);
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar Toggler(basculer) (Sidebar) -->
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form action="categorie.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nom de la catégorie</label>
                                    <input type="text" value="<?php echo $cat[0]['cat_nom']?>"name="nom" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">

                                </div>
                                <div class="form-group">

                                    <input style="display : none" type="text" value="<?php echo $cat[0]['cat_id']?>"name="catid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
