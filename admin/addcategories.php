...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar Toggler (Sidebar) barre lateral -->
    ...
    <!-- Fin de la barre-lateral (Sidebar) -->
                        ...
                        <div class="table-responsive">
                            <form action="categorie.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" value=""name="nom" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
